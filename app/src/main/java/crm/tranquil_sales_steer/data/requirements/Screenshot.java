...
public class Screenshot {
    ...
    public void shareScreenShot(Bitmap bitmap) {
        ...
        try {
            ...
            String path = MediaStore.Images.Media.insertImage(activity.getContentResolver(), bitmap, String.valueOf(System.currentTimeMillis()), null);
    ...
    private void newNotification() {
        ...
        if (VERSION.SDK_INT >= 16) {
            ...
            shareIntent.putExtra(Intent.EXTRA_STREAM, Uri.parse(filePathBackup));
        ...
        intent.setDataAndType(Uri.parse(filePathBackup), "image/*");
