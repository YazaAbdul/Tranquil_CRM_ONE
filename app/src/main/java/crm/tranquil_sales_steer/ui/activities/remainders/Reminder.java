...
public class Reminder {
    ...
    public Reminder(int ID, String Title, String Date, String Time, String Repeat, String RepeatNo, String RepeatType, String Active, String Requirement, String ActivityName) {
        mID = ID;
        mTitle = Title;
        mDate = Date;
        mTime = Time;
    ...
    public Reminder(String Title, String Date, String Time, String Repeat, String RepeatNo, String RepeatType, String Active, String Requirement, String ActivityName) {
        mTitle = Title;
        mDate = Date;
        mTime = Time;
        mRepeat = Repeat;
