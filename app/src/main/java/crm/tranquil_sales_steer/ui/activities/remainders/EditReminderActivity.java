...
public class EditReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.remainders);
        ...
        if (savedInstanceState != null) {
            ...
            String savedReq = savedInstanceState.getString(KEY_REQUIREMENT);
            mRequirement = savedReq;


            String savedActivity = savedInstanceState.getString(KEY_ACTIVITY_NAME);

            mActivityName = savedActivity;
        }
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putCharSequence(KEY_REQUIREMENT, mRequirement);
        outState.putCharSequence(KEY_ACTIVITY_NAME, mActivityName);
    }
    ...
    public void updateReminder(){
        ...
        mReceivedReminder.setmRequirement(mRequirement);
        mReceivedReminder.setmActivityName(mActivityName);
