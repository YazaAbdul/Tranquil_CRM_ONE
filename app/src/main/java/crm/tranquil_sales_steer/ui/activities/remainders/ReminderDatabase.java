...
public class ReminderDatabase extends SQLiteOpenHelper {
    ...
    public int addReminder(Reminder reminder){
        ...
        values.put(KEY_REQUIREMENT,reminder.getmRequirement());
        values.put(KEY_ACTIVITY_NAME,reminder.getmActivityName());
    ...
    public List<Reminder> getAllReminders(){
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                reminder.setmRequirement(cursor.getString(8));
                reminder.setmActivityName(cursor.getString(9));
