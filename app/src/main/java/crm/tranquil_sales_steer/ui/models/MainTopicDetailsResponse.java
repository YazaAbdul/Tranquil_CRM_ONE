...
public class MainTopicDetailsResponse {
    ...
    public MainTopicDetailsResponse(String id, String name, String color_start, String color_end, String color_light, String color_light2, int image) {
        this.id = id;
        this.name = name;
