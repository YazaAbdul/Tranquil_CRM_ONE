...
public class CreateivesFragmentoneAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CreateivesFragmentoneAdapter(Activity activity, ArrayList<ImagescreateiveResponse> imagescreateiveResponse, CreativeClickListener creativeClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_ITEM:
                viewHolder = new CreateivesFragmentoneAdapter.CreativesVH(inflater.inflate(R.layout.creatives_recycler_item, parent, false));
                break;

            case VIEW_LOADING:
                viewHolder = new CreateivesFragmentoneAdapter.CreativesVH(inflater.inflate(R.layout.progressbar1, parent, false));
...
//                CreativesVH itemVH = (CreativesVH) holder;
                ...
                //cpUserNameStr = MySharedPreferences.getPreferences(activity,"" + AppConstants.SharedPreferenceValues.USER_NAME); //tryed this also
                // cpUserNameStr = MySharedPreferences.getPreferences(activity.getActivity(), "" + AppConstants.CP_PROFILE_PIC);

                //   cpUserNameStr = MySharedPreferences.getPreferences((Context) activity.getText(position), "" + AppConstants.CP_USER_NAME);
                ...
                // Toast.makeText(activity, ""+cpUserNameStr, Toast.LENGTH_SHORT).show();
...
//                itemVH.agentDetailsRLID.setVisibility(View.VISIBLE);
    ...
    public class CreativesVH extends RecyclerView.ViewHolder {
        ...
        AppCompatTextView greetingsTVID;
