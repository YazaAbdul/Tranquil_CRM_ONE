 ...
 */
public class RequirementsAdapter extends ArrayAdapter<RequirementResponse> {

    List<RequirementResponse> doubtsClassesResponces;

    public RequirementsAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<RequirementResponse> doubtsClassesResponces) {
    ...
    public View getView(int position, @Nullable View view, @NonNull ViewGroup parent) {
        RequirementResponse category = getItem(position);
        ...
        parentViewHolder.spinnerText.setText(TextUtils.isEmpty(category.getRequirement_name()) ? "" : category.getRequirement_name());
        return view;
    }
    ...
    public View getDropDownView(int position, @Nullable View view, @NonNull ViewGroup parent) {
        ...
        holder.spinnerText.setText(TextUtils.isEmpty(category.getRequirement_name()) ? "" : category.getRequirement_name());
        return view;
    }
}
