...
import crm.tranquil_sales_steer.ui.adapters.CreateivesFragmenttwoAdapter;
 ...
 */
public class FragmentCreativesWithOut extends Fragment {
     ...
     * @return A new instance of fragment FragmentCreativesWithOut.
     */
    ...
    CreateivesFragmenttwoAdapter adapter;
    ProgressBar pb;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_creatives_with_out, container, false);
    ...
    private void loadCreatives() {
        ...
        adapter = new CreateivesFragmenttwoAdapter(getActivity(),imagescreateiveResponse, this::onCreativeItemClick);
    ...
    public void onCreativeItemClick(ImagescreateiveResponse response, View v, int pos, CreateivesFragmenttwoAdapter.CreativesVH holder) {
        switch (v.getId()) {
            case R.id.whatsAppShareIVID:
                try {
//                    Toast.makeText(getContext(), "Clickd witout whatsappicon", Toast.LENGTH_SHORT).show();
    ...
    private void shareToSocialMedia(Bitmap bitmap, String socialMediaType) {
        ...
        try {
            ...
            if (socialMediaType.equalsIgnoreCase("2")){
                ...
                Toast.makeText(getActivity(), "Business whatsapp is not installed in your device", Toast.LENGTH_SHORT).show();
