...
import crm.tranquil_sales_steer.recordings.app.Recordings;
import crm.tranquil_sales_steer.recordings.app.Storage;
import crm.tranquil_sales_steer.recordings.app.SurveysReader;
import crm.tranquil_sales_steer.recordings.services.RecordingService;
import crm.tranquil_sales_steer.recordings.services.VoiceRecognitionService;
...
public class MainActivity extends AppCompatThemeActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_about:
                ...
                LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.call_survey_title, null);
                ...
                if (raw == 0) {
                    ...
                    SurveysReader reader = new SurveysReader(getResources().openRawResource(raw), new String[]{null, null, Build.MANUFACTURER, Build.MODEL});
    ...
    void updatePanel() {
        ...
        if (recording == null) {
            ...
            fab.setImageResource(R.drawable.call_ic_stop_black_24dp);
        } else {
    ...
    private boolean isAccessibilitySettingsOn(Context mContext) {
        ...
        final String service = getPackageName() + "/" + VoiceRecognitionService.class.getCanonicalName();
        try {
