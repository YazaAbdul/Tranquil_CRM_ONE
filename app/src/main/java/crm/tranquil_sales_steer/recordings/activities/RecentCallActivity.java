...
public class RecentCallActivity extends AppCompatActivity {
    ...
    int getAppTheme() {
        return CallApplication.getTheme(this, R.style.AppThemeDialogDark, R.style.AppThemeDialogDark);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View v = inflater.inflate(R.layout.call_activity_recentcall, null);
    ...
    void updateFav() {
        fav.setImageResource(CallApplication.getStar(this, uri) ? R.drawable.ic_star_black_24dp : com.github.axet.audiolibrary.R.drawable.ic_star_border_black_24dp);
    }
